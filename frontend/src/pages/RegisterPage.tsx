        ...
        <div className="bg-white border border-[#C8E6D4] rounded-xl p-8">
          ...
          <div className="relative my-5">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#C8E6D4]" />
            </div>
            <div className="relative flex justify-center text-xs text-[#7A9E87] bg-white px-2">or</div>
          </div>

          <button
            onClick={handleGoogle}
            disabled={loading}
            className="w-full border border-[#C8E6D4] hover:bg-[#E8F5EE] text-[#0D2818] font-medium rounded-lg py-2.5 text-sm transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
          >
