...
export function InterviewPage() {
  ...
  // Auto-generate brief when interview reaches Closing phase
  useEffect(() => {
    if (phase === 'CLOSING' && !isGenerating && !autoGeneratedRef.current && sessionInfo) {
      autoGeneratedRef.current = true;
      setTimeout(() => generateBrief(), 2000);
    }
  }, [phase, isGenerating, sessionInfo, generateBrief]);
